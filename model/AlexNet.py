...
class Agent_AlexNet_2(nn.Module):

    def __init__(self):

        super(Agent_AlexNet_2, self).__init__()
    ...
    def forward(self, x):
        ...
        x = self.classifier_first_layer(x)

        return x


class Server_AlexNet_2(nn.Module):

    def __init__(self, num_classes):

        super(Server_AlexNet_2, self).__init__()
