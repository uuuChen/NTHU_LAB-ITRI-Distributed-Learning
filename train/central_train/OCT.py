...
# 資料路徑
train_img_path = 'data/OCT/sample_1'
test_img_path = 'data/OCT/sample_test1'
...
# 畫圖參數
save_acc = open("record/OCT_acc.txt", "w")
train_loss = []
train_acc = []
test_loss = []
test_acc = []
...
def _iter_epoch(is_training, epoch):
    ...
    for batch_idx in range(1, batches + 1):
        ...
        for data_, target_ in data:
            ...
            # 每個點為 0 ~ 255，需要 / 255
            data_ = np.array(Image.open(data_)) / 255
...
def plot_acc_loss(end_epoch):
    ...
    plt.legend()
    plt.savefig("record/OCT_loss.png", dpi=300, format="png")
    ...
    plt.legend()
    plt.savefig("record/OCT_acc.png", dpi=300, format="png")
